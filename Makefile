...
PROGNAME = Flappy_Birds

# Here you must put a list of all of the object files
# that will be compiled into your program. For example
# if you have main.c and myLib.c then in the following
# line you would put main.o and myLib.o
OFILES = font.o myLib.o objects.o runner.o Sprite.o End.o Start.o Low.o High.o Neutral.o draw.o game.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h objects.h Sprite.h End.h Start.h Low.h High.h Neutral.h draw.h game.h
